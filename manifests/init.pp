...
#   parameters accepted are the same as the <tt>bareos::client::config</tt> define.
# [*console_password*]
...
# [*director_server*]
#   The FQDN of the bareos director
# [*director_template*]
...
# [*manage_config_dir*]
#   Whether to purge all non-managed files from the bareos config directory
# [*manage_console*]
...
#   to define additional devices in Bacula which use the same disk. Defaults to <tt>'/mnt/bareos'</tt>.
# [*storage_server*]
...
# [*volume_autoprune*]
#   {Auto prune volumes}[http://www.bareos.org/5.0.x-manuals/en/main/main/Configuring_Director.html#AutoPrune] in
#   the default pool.
...
# [*volume_retention*]
#   Length of time to {retain volumes}[http://www.bareos.org/5.0.x-manuals/en/main/main/Configuring_Director.html#VolRetention] in
#   the default pool.
